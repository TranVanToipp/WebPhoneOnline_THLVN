...
?>
<?php
$s_title = $s_price = $s_discount = $s_number = $s_unit ='';
if(!empty($_POST)){
	$s_id = $_POST['id'];
	$s_title = $_POST['title'];
	$s_IDLSP = $_POST['IDLSP'];
                ...
                <form method="post" action="" enctype="multipart/form-data">
					...
					<div class="form-group">
						...
						foreach($LoaiSP as $row){
							echo "<option value='".$row['loaisp']."'>".$row['TenLoaiSP']."</option>";
						}
						echo "</select>";
						?></td>
                    </div>
					...
					<select id="disco" name="giamgia">
						...
						<option value="1">Giảm Giá 10%</option>
						<option value="2">Giảm Giá 20%</option>
						<option value="3">Giảm Giá 30%</option>
						<option value="4">Giảm Giá 40%</option>
					</select>
					</div>
                    <div class="form-group">
					...
					<div class="form-group">
                        ...
                        <input type="checkbox" name="checkspNB" value="1" style="width: 5%;">
                    </div>
                    <div class="form-group">
                        <label for="" style="font-weight: bold;">Thông tin sản phẩm:</label>
                        <textarea class="form-group" name="description" id="" style="width: 100%;" rows="5" name="description"></textarea>
                    </div>
                    <div class="form-group">
