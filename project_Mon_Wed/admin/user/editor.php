...
<?php
	...
	if($user != null && count($user)>0){
		$s_nameofuser = $user['TenKH'];
		$s_address = $user['DiaChiKH'];
		$s_sdt = $user['SDT'];
	}
	else
		$id='';
            ...
            <div class="panel-body">
                <form method="post" action="" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <input type="text" required="true" class="form-control" name="NameOfUser" placeholder="Nhập tên khách hàng" value="<?=$s_nameofuser?>">
                    </div>
					<div class="form-group">
